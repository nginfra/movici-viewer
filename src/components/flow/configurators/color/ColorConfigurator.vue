...
import ColorLegendLabelsConfigurator from '@/components/flow/configurators/color/ColorLegendLabelsConfigurator.vue';
import { getLegendPlaceholders, PlaceholderType } from '@/components/flow/configurators/helpers';
